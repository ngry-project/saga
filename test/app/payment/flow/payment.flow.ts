...
import { CommandHandler } from '../../../../src/lib/command/command-handler.decorator';
import { Saga } from '../../../../src/lib/saga/saga.decorator';
...
export class PaymentFlow {
  ...
  retryAfterBalanceTopUp(event$: Observable<BalanceTopUpDoneEvent<PaymentContext>>): Observable<ICommand> {
    return event$.pipe(
